...
#line 182 "casper/java/fake_java_scanner.rl"
...
#line 190 "casper/java/fake_java_scanner.rl"
...
#line 213 "casper/java/fake_java_scanner.rl"
}
...
#line 1 "NONE"
	...
	goto st202;
tr3:
#line 147 "casper/java/fake_java_scanner.rl"
	{{(     p_) = (((    te_)))-1;}{
                             if ( (int)(te_ - ts_) - 2 < 0 ) {
                                *o_val = "";
                                ret = (FakeJavaParser::token_type) '"';
...
#line 64 "casper/java/fake_java_scanner.rl"
	...
	goto st202;
tr225:
#line 118 "casper/java/fake_java_scanner.rl"
	{(    te_) = (     p_)+1;{ ret = FakeJavaParser::token::OR        ; {(     p_)++; (    cs_) = 202; goto _out;} }}
	goto st202;
tr226:
#line 179 "casper/java/fake_java_scanner.rl"
	{(    te_) = (     p_)+1;}
	goto st202;
tr229:
...
#line 1 "NONE"
	{(    ts_) = (     p_);}
#line 537 "casper/java/fake_java_scanner.cc"
	switch( (*(     p_)) ) {
		case 32: goto tr226;
		case 33: goto st203;
		case 34: goto st1;
...
st1:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof1;
case 1:
#line 604 "casper/java/fake_java_scanner.cc"
	if ( (*(     p_)) == 34 )
		goto tr2;
	goto st1;
tr2:
...
st204:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof204;
case 204:
#line 626 "casper/java/fake_java_scanner.cc"
	if ( (*(     p_)) == 34 )
		goto st2;
	goto tr268;
st2:
...
st205:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof205;
case 205:
#line 813 "casper/java/fake_java_scanner.cc"
	switch( (*(     p_)) ) {
		case 46: goto st14;
		case 69: goto st15;
		case 101: goto st15;
...
st206:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof206;
case 206:
#line 846 "casper/java/fake_java_scanner.cc"
	switch( (*(     p_)) ) {
		case 69: goto st15;
		case 101: goto st15;
	}
...
st16:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof16;
case 16:
#line 875 "casper/java/fake_java_scanner.cc"
	if ( 48 <= (*(     p_)) && (*(     p_)) <= 57 )
		goto tr23;
	goto tr20;
tr23:
...
st207:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof207;
case 207:
#line 890 "casper/java/fake_java_scanner.cc"
	if ( 48 <= (*(     p_)) && (*(     p_)) <= 57 )
		goto tr23;
	goto tr270;
st208:
...
st210:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof210;
case 210:
#line 988 "casper/java/fake_java_scanner.cc"
	if ( (*(     p_)) == 70 )
		goto st27;
	goto tr278;
st27:
...
st211:
	if ( ++(     p_) == (    pe_) )
		goto _test_eof211;
case 211:
#line 1764 "casper/java/fake_java_scanner.cc"
	switch( (*(     p_)) ) {
		case 66: goto st134;
		case 68: goto st140;
		case 73: goto st145;
...
#line 221 "casper/java/fake_java_scanner.rl"
