...
void casper::jrxml::StretchTypeAttr::FromStr (const pugi::char_t* a_value)
{
    ...
    %%{
        machine StretchTypeAttr;

        main := |*
            ''
            'NoStretch'               => { value_ = ENoStretch;               };
            'RelativeToTallestObject' => { value_ = ERelativeToTallestObject; };
            'RelativeToBandHeight'    => { value_ = ERelativeToBandHeight;    };
        *|;
