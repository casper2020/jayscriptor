...
#line 1 "src/casper/jrxml/line_style_attr.rl"
/**
...
#line 42 "src/casper/jrxml/line_style_attr.cc"
static const int line_style_attr_start = 17;
static const int line_style_attr_first_final = 17;
static const int line_style_attr_error = 0;

static const int line_style_attr_en_main = 17;


#line 50 "src/casper/jrxml/line_style_attr.cc"
	{
	cs = line_style_attr_start;
	ts = 0;
	te = 0;
	act = 0;
	}

#line 58 "src/casper/jrxml/line_style_attr.cc"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
	{
tr6:
#line 44 "src/casper/jrxml/line_style_attr.rl"
	{te = p+1;{ value_ = EDashed; }}
	goto st17;
tr11:
#line 45 "src/casper/jrxml/line_style_attr.rl"
	{te = p+1;{ value_ = EDotted; }}
	goto st17;
tr14:
#line 46 "src/casper/jrxml/line_style_attr.rl"
	{te = p+1;{ value_ = EDouble; }}
	goto st17;
tr18:
#line 43 "src/casper/jrxml/line_style_attr.rl"
	{te = p+1;{ value_ = ESolid;  }}
	goto st17;
st17:
#line 1 "NONE"
	{ts = 0;}
...
#line 1 "NONE"
	{ts = p;}
#line 88 "src/casper/jrxml/line_style_attr.cc"
	switch( (*p) ) {
		case 68: goto st1;
		case 83: goto st13;
	}
...
#line 52 "src/casper/jrxml/line_style_attr.rl"
