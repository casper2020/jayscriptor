/**
 * @file rectangle.h declaration of Rectangle model node
 *
 ...
 */
#pragma once
#ifndef NRS_CASPER_CASPER_JRXML_RECTANGLE_H
#define NRS_CASPER_CASPER_JRXML_RECTANGLE_H
...
namespace casper
{
    namespace jrxml
    {
        ...
        /**
         * @brief Definition of a rectangle object
         */
        class Rectangle  : public Node
        {
        public: // Attributes

            DimAttr  radius_;   //!< The radius of the arc corner
        ...
        public: // Methods
            ...
            static Rectangle* CreateFromXml (pugi::xml_node a_node, Node* a_parent) ;
...
#endif // NRS_CASPER_CASPER_JRXML_RECTANGLE_H
