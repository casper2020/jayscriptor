...
#line 1 "src/casper/jrxml/pos_attr.rl"
/**
 * @file dim_attr.rl Implementation of PosAttr model attribute
 *
 ...
 */
void casper::jrxml::PosAttr::FromStr (const pugi::char_t* a_value)
{
    float tmp;
