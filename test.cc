...
int main(int argc, char* argv[]) {
    ...
    //singleton.Startup("/Users/bruno/work/jayscriptor/out/darwin/0920/Products/Debug/v8_teste" );
...
//        v8::Local<v8::String> file_name = v8::String::NewFromUtf8(context->GetIsolate(), script_file.c_str(), v8::NewStringType::kNormal).ToLocalChecked();

//        if ( false == client_context->ExecuteString(source, file_name, false, true) ) {
